...
description: "Qwant précise dans sa politique de vie privée, le type de données qu’elle transmet à son partenaire Microsoft..."
dates: ["2021-11-02"]
grid.cols: 9
grid.gutters: 8
breadcrumb:
  - name: Étude de cas
    url: /fr/case-studies
  - name: Qwant détaille les données partagées avec Microsoft
---
