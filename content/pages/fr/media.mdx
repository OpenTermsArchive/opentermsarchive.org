...
- Le plus souvent possible, des espaces insécables doivent être utilisés pour séparer les trois mots, afin d'éviter les sauts de ligne au milieu du nom.
...
<h2 className="mb__0 mt__4XL">Revue de presse</h2>
<h4 className="h4__light mb__3XL">Ces articles mentionnent Open Terms Archive</h4>

### Le Club de Mediapart

<p className="text__smallcaps">20 juin 2022</p>
...
>
  <Button type="secondary">Lire</Button>
</a>
...
<p className="text__smallcaps">21 janvier 2022</p>
...
<p className="text__smallcaps">27 septembre 2021</p>
...
<p className="text__smallcaps">19 avril 2021</p>
...
<p className="text__smallcaps">Février 2021</p>
...
<a
  ...
  title="Open Terms Archive : rééquilibrer le rapport de force entre les grands opérateurs de services numériques et leurs utilisateurs"
>
  <Button type="secondary">Lire</Button>
</a>
...
<p className="text__smallcaps">22 février 2021</p>
...
<p className="text__smallcaps">17 février 2021</p>
...
<p className="text__smallcaps">16 février 2021</p>
