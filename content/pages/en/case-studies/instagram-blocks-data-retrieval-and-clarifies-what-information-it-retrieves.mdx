...
description: "Instagram made several updates to its community rules, its terms of use and its privacy policy..."
grid.cols: 9
grid.gutters: 8
breadcrumb:
  - name: Case studies
    url: /case-studies
  - name: Instagram blocks data retrieval and clarifies what information it retrieves
---
