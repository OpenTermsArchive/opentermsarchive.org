...
When you subscribe to the document change tracking service (the form on the home page), we collect your email address. This allows us to notify you when a modification is detected on the document you have selected.
