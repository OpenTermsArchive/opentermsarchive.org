...
Lorsque que vous souscrivez au service de suivi des modifications d'un document (le formulaire présent sur la page d'accueil), nous collectons votre adresse email. Cela nous permet de vous avertir lorsqu'une modification est detectée sur le document que vous avez sélectionné.
Cet email est stocké dans une liste Sendinblue (https://www.sendinblue.com).
